...
namespace Core.Security.Extensions
{
    ...
    {
        public static List<string>? Claims(this ClaimsPrincipal claimsPrincipal, string claimType) => claimsPrincipal?.FindAll(claimType)?.Select(claim => claim.Value).ToList();
